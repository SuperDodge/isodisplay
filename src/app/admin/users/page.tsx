        ...
        <div className="bg-white/10 backdrop-blur-md rounded-lg shadow-xl p-8 border border-white/20 custom-scrollbar">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl font-bold text-white uppercase tracking-wide font-['Made_Tommy']">
                User Management
              </h1>
            </div>
          ...
          <div className="mb-6 space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-brand-orange-500"
              />
            </div>
                        ...
                        <td className="p-4">
                          <div className="flex flex-wrap gap-1">
                            {user.permissions.map((permission) => (
                              <span
                                key={permission}
                                className="px-2 py-1 bg-brand-orange-500/20 text-brand-orange-300 text-xs rounded border border-brand-orange-500/30"
                              >
                                {permission.replace('_', ' ')}
                              </span>
                            ))}
                                ...
                                {Object.values(Permission).map((permission) => (
                                  <label key={permission} className="flex items-center gap-2 text-xs">
                                    <input
                                      ...
                                      onChange={() => handlePermissionToggle(user.id, permission, user.permissions.includes(permission))}
                                      className="rounded border-white/20 bg-white/10"
                                    />
